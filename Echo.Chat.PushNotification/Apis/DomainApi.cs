...
namespace Echo.Chat.PushNotification.API;

public static class DomainApi
{
    public static IEndpointRouteBuilder MapPushNotificationApiV1(this IEndpointRouteBuilder app)
    {
        var api = app.MapGroup("api/domain").HasApiVersion(1.0);
        ...
        //default old way of doing things
        //app.MapControllers();
