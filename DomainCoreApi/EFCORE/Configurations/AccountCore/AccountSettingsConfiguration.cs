...
namespace DomainCoreApi.EFCORE.Configurations.AccountCore
{
    public class AccountSettingsConfiguration : IEntityTypeConfiguration<AccountSettings>
    {
        public void Configure(EntityTypeBuilder<AccountSettings> builder)
        {
            ...
            builder.HasOne(b=>b.VideoSettings).WithOne(b => b.AccountSettings).HasForeignKey<VideoSettings>(b => b.AccountSettingsId).OnDelete(DeleteBehavior.Cascade);
            builder.HasOne(b=>b.VoiceSettings).WithOne(b => b.AccountSettings).HasForeignKey<VoiceSettings>(b => b.AccountSettingsId).OnDelete(DeleteBehavior.Cascade);
