...
namespace DomainCoreApi.EFCORE.Configurations.AccountCore
{
        ...
        //but messages and metadata such as mutes, roles, etc might remain.
    {
        public void Configure(EntityTypeBuilder<Account> builder)
        {
            ...
            builder.HasOne(b => b.Profile).WithOne(b=>b.Account).HasForeignKey<AccountProfile>(b=>b.Id).OnDelete(DeleteBehavior.Cascade).IsRequired(); //skal lige kig på det kan ikke lige find ud hvorfor den ikke vil får en "Compiler Error CS0452"
            
            builder.HasMany(e => e.Connections).WithOne(e => e.Account).HasForeignKey(b => b.AccountId).OnDelete(DeleteBehavior.Cascade).IsRequired();
            ...
            builder.HasMany(e => e.MutedServers).WithOne(e => e.Muter).HasForeignKey(e=>e.MuterId).OnDelete(DeleteBehavior.Cascade).IsRequired();
            builder.HasMany(e => e.MutedTextChannels).WithOne(e => e.Muter).HasForeignKey(e=>e.MuterId).OnDelete(DeleteBehavior.Cascade).IsRequired();
            builder.HasMany(e => e.MutedVoiceChannels).WithOne(e => e.Muter).HasForeignKey(e=>e.MuterId).OnDelete(DeleteBehavior.Cascade).IsRequired();
            ...
            builder.HasMany(e => e.Servers).WithOne(e => e.Account).HasForeignKey(e=>e.AccountId).OnDelete(DeleteBehavior.Cascade).IsRequired();
            ...
            builder.HasMany(e => e.Folders).WithOne(e => e.Account).HasForeignKey(e=>e.AccountId).OnDelete(DeleteBehavior.Cascade).IsRequired();
