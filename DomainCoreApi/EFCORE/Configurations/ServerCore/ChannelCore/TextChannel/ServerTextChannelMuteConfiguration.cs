...
{
    public class ServerTextChannelMuteConfiguration : IEntityTypeConfiguration<ServerTextChannelMute>
    {
        public void Configure(EntityTypeBuilder<ServerTextChannelMute> builder)
        {
