...
namespace DomainCoreApi.EFCORE.Configurations.ServerCore.ChannelCore.TextChannel
{
    public class ServerTextChannelMessageConfiguration : IEntityTypeConfiguration<ServerTextChannelMessage>
    {
        public void Configure(EntityTypeBuilder<ServerTextChannelMessage> builder)
        {
            ...
            builder.HasOne(b => b.Author).WithMany(e => e.ChannelMessages).HasForeignKey(b => b.AuthorId).OnDelete(DeleteBehavior.ClientCascade).IsRequired();
            ...
            builder.HasOne(b => b.MessagePin).WithOne(b => b.Message).HasForeignKey<ServerTextChannelMessagePin>(b => b.MessageId).OnDelete(DeleteBehavior.ClientCascade).IsRequired();
