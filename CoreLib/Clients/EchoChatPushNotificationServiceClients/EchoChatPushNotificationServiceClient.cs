...
namespace Echo.Application.Clients.EchoChatPushNotificationServiceClients;

public partial class EchoChatPushNotificationServiceClient : IDisposable
{
    ...
    public EchoChatPushNotificationServiceClient(/*string serverip*/)
    {
        //ServerIP = serverip;
        Disposing = () =>
        {
