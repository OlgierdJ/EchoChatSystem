...
{
    public class ActiveActivityStatusDTO : ActivityStatusMinimalDTO //the displayed status which is a combination of the actual status and the custom status id.
    {
