...
namespace Echo.Domain.EntityFrameworkCore.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AccountConnection_ConnectionType_ConnectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TextChannelId = table.Column<decimal>(type: "decimal(20,0)", nullable: true),
                    VoiceChannelId = table.Column<decimal>(type: "decimal(20,0)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "AuthenticationEndpoint", "AuthorizationEndpoint", "AuthorizeEndpoint", "ExchangeReturnEndpoint", "PlatformIcon", "PlatformName", "TokenCheckEndpoint", "TokenRefreshEndpoint" },
                values: new object[,]
                {
                    { 1L, "PayPal.com/api/v3/authenticate", "PayPal.com/api/v3/authorization", "PayPal.com/api/v3/authorize", "PayPal.com/api/v3/token/exchange", "PayPalIcon.png", "PayPal", "PayPal.com/api/v3/token/validate", "PayPal.com/api/v3/token/refresh" },
                    { 2L, "stripe.com/api/v3/authenticate", "stripe.com/api/v3/authorization", "stripe.com/api/v3/authorize", "stripe.com/api/v3/token/exchange", "CreditCard.png", "Card", "stripe.com/api/v3/token/validate", "stripe.com/api/v3/token/refresh" }
                });
