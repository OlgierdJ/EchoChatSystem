...
{
    private readonly EchoAPIServerClient _apiClient;
    private readonly PushNotificationClientConnectionStore userConnectionStore;

    public PushNotificationHub(EchoAPIServerClient apiClient, PushNotificationClientConnectionStore connectionStore)
    {
