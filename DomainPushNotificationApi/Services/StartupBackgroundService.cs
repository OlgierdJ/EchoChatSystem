...
public class StartupBackgroundService : BackgroundService
{
    ...
    private readonly EchoAPIServerClient _echoAPIServerClient;

    public StartupBackgroundService(DomainNotificationClientService service, PushNotificationService notificationService, ITokenProvider tokenStore, EchoAPIServerClient echoAPIServerClient)
    {
        _service = service;
